...
## Notices
- Sigma Spy will have bugs, please report any bugs by opening an [issue](https://github.com/Jsssiee/Sigma-Spy/issues) on Github
- If you gave a suggestion, please post it in the [discussions](https://github.com/Jsssiee/Sigma-Spy/discussions)
- Please do not use Potassium in games with Actors as Potassium's crude implimentations break

## Loadstring
```lua
--// Sigma Spy @depso
loadstring(game:HttpGet("https://raw.githubusercontent.com/Jsssiee/Sigma-Spy/refs/heads/main/Main.lua"), "Sigma Spy")()
```
